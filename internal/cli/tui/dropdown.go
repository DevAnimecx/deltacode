...
func slashItems() []ddItem {
	return []ddItem{
		...
		{label: "/compact", desc: "Summarize session", value: "/compact"},
		{label: "/timeline", desc: "Show session timeline", value: "/timeline"},
		{label: "/mcp", desc: "List MCP servers", value: "/mcp"},
		{label: "/share", desc: "Share session", value: "/share"},
		{label: "/unshare", desc: "Unshare session", value: "/unshare"},
		{label: "/fork", desc: "Fork session", value: "/fork"},
		{label: "/rename", desc: "Rename session", value: "/rename"},
		{label: "/delete", desc: "Delete session", value: "/delete"},
